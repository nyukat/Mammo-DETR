...
import src.modeling.def_detr.util.box_ops as box_ops
from src.modeling.def_detr.util.misc import NestedTensor, interpolate, nested_tensor_from_tensor_list
...
def sigmoid_focal_loss(inputs, targets, num_boxes, alpha: float=0.25, pos_gamma: float=2, neg_gamma: float=2, mask:torch.Tensor=None,
    ...
    Args:
        ...
        mask: None or N,C binary tensor
    Returns:
        Loss tensor
    """
    prob = inputs.sigmoid()
    ...
    gamma = pos_gamma * targets + neg_gamma * (1 - targets)
